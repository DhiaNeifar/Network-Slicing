...
def main():
    ...
    (solution, virtual_links, are_deployed,
     unassigned_cpus, missing_TP) = flexible_network_slicing(number_slices, total_number_centers, total_available_cpus,
                                                             edges_adjacency_matrix, total_available_bandwidth,
                                                             edges_delay, number_VNFs, required_cpus,
                                                             required_bandwidth, delay_tolerance)
